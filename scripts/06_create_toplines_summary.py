...
def current_season_stats(standings_now, standings_past, pitching, pitching_ranks, standings_last):
    ...
    # had to remove ranks until/unless SR restores ranks to the pitching data
    ...
    return games, wins, losses, record, win_pct, win_pct_decade_thispoint, era, strikeouts, walks, wins_last, losses_last, record_last, win_pct_last, home_runs_allowed
...
def run_differential(standings, batting_ranks):
    ...
    # had to remove runs_rank until/unless SR restores ranks to the batting data
    ...
    return runs, runs_last, runs_against, runs_against_last, run_diff, run_diff_last, mean_attendance, formatted_mean_attendance, home_games_count
...
def home_run_stats(batting_now, batting_past, batting_ranks):
    ...
    # Had to remove ranks until SR restores ranks to the batting data
...
def batting_and_stolen_base_stats(batting_now, batting_past, games, batting_ranks):
    ...
    # Had to remove stolen_bases_rank until SR restores ranks to the batting data
    ...
    return batting_average, batting_average_decade, stolen_bases, stolen_bases_game, stolen_bases_last_rate, on_base_pct, on_base_pct_decade
...
games, wins, losses, record, win_pct, win_pct_decade_thispoint, era, strikeouts, walks, wins_last, losses_last, record_last, win_pct_last, home_runs_allowed = current_season_stats(standings_now, standings_past, pitching, pitching_ranks, standings_last)
runs, runs_last, runs_against, runs_against_last, run_diff, run_diff_last, mean_attendance, formatted_mean_attendance, home_games_count = run_differential(standings, batting_ranks)
home_runs, home_runs_game, home_runs_game_last, home_runs_game_decade = home_run_stats(batting_now, batting_past, batting_ranks)
batting_average, batting_average_decade, stolen_bases, stolen_bases_game, stolen_bases_last_rate, on_base_pct, on_base_pct_decade = batting_and_stolen_base_stats(batting_now, batting_past, games, batting_ranks)
win_count_trend, loss_count_trend, win_loss_trend = recent_trend(standings.iloc[:10])
...
summary_data = [
    ...
    #  With ranks removed until SR restores ranks to the data
    ...
    {"stat_label": "Runs", "stat": "runs", "value": runs, "category": "standings",  "context_value_label": "League rank"},
    ...
    {"stat_label": "Home runs", "stat": "home_runs", "value": home_runs, "category": "batting",  "context_value_label": "League rank"},
    ...
    {"stat_label": "Stolen bases", "stat": "stolen_bases", "value": stolen_bases, "category": "batting", "context_value_label": "League rank"},
    ...
    # Pitching
    {"stat_label": "Strikeouts", "stat": "strikeouts", "value": strikeouts, "category": "pitching", "context_value_label": "League rank"},
    {"stat_label": "Walks", "stat": "walks", "value": walks, "category": "pitching", "context_value_label": "Rank",  "context_value_label": "League rank"},
    ...
    {"stat_label": "ERA", "stat": "era", "value": era, "category": "pitching", "context_value_label": "Rank", "context_value_label": "League rank"},
