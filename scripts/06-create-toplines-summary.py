...
def generate_summary(standings_now, wins, losses, win_pct):
    ...
    summary = (
        f"The Dodgers have played <span style='highlight'>{games}</span> games this season, compiling a {record} record and "
        f"a winning percentage of <span style='highlight'>{win_pct}</span>%. The team's latest game was a "
        ...
        f"They've won <span style='highlight'>{win_count_trend} of the last 10 games</span>."
    )
    return summary
...
summary_data = [
    ...
    {"stat_label": "Win %", "stat": "win_pct", "value": f"{win_pct}%", "category": "standings"},
    {"stat_label": "Win % last decade", "stat": "win_pct_decade_thispoint", "value": f"{win_pct_decade_thispoint}%", "category": "standings"},
    ...
    {"stat_label": "HR/game", "stat": "home_runs_game", "value": home_runs_game, "category": "batting"},
    # {"stat_label": "HR/game 2023", "stat": "home_runs_game_last", "value": home_runs_game_last, "category": "batting"},
    ...
    {"stat_label": "Stolen/game", "stat": "stolen_bases_game", "value": stolen_bases_game, "category": "batting"},
